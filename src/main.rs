...
fn main() {
    let bad_class_files = vec![
        ...
        ("EmptyConstantPool.class", empty_constant_pool()),
        ("EnumInterface.class", enum_interface()),
        ("AbstractEnum.class", abstract_enum()),
    ];
...
fn empty_constant_pool() -> ClassFile {
    use Bytecode::*;
...
fn abstract_enum() -> ClassFile {
    ...
    ClassFile {
        ...
        constant_pool: vec![
            ...
            Box::new(ConstantUtf8 {
                string: "AbstractEnum.java".to_string(),
            }),
            Box::new(ConstantNameAndType {
                name_index: 7,
                descriptor_index: 8,
